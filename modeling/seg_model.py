...
if __name__ == "__main__":
    # pretrianed_weights_path = "/home/olg7848/p32335/my_research/vlp_ct/checkpoints/vision_ssl/model_swinvit.pt"
    # pretrianed_weights_path = "/home/olg7848/p32335/my_research/vlp_ct/checkpoints/vision_ssl/vis_ssl-swinvit-m3d_cap-dr1.0-E25-best/pytorch_model.bin"
    # model = load_segmenter("swinunetr", pretrianed_weights_path)
    # print(model)

    device = "cuda"
    config_path = "./config_dt/seg_abdomenct1k_topitc_BtSv.yaml" 
    ...
    ckpt_path = "./checkpoints_dt/seg_abdomenct1k_topitc_BtSv/seg-abdomenct1k-dr1.0-FvisFalse-E55-best/pytorch_model.bin"
    ...
    transforms = MonaiTransforms(num_samples=1)
    ...
    # visualize_transformed_data(train_dataset, 1, SliceMap.btcv["train"], save=True)

    train_dataloader = ThreadDataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=4)
    val_dataloader = ThreadDataLoader(val_dataset, batch_size=1, shuffle=False, num_workers=4)
    ...
    model.eval()
    re = model.test_on_dataloader(val_dataloader)
