...
if __name__ == "__main__":
    ...
    with open(visiontext_config_filepath, "r") as f:
    ...
    num_trainable_params = count_params(model.vision_ssl.vision_encoder)
    ...
    # print_dict_content(re[0])
    re = model.test_on_dataloader(dataloader, 0, requires_match_score=False, similarity_type="t")
